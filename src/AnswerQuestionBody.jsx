      ...
      trigger={
        <div className="d-flex gap-1">
          <Button
            variant="contained"
            size="large"
            className="mb-2 gap-2 justify-content-start"
            style={{
              flex: "1",
              backgroundColor: "#684EB2",
              color: "white",
              textTransform: "none",
            }}
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <Radio
                          ...
                          icon={
                            parseInt(option.name.split(" ")[0]) <
                            parseInt(
                              checkedChoice === undefined
                                ? 0
                                : checkedChoice.split(" ")[0]
                            ) ? (
